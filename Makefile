...
lib.release			:=  -lX11 -lXext -Lminilibx-linux -lmlx -L./Lib42 -l42
...
# Bonus rule
bonus: CFLAGS += -DBONUS
bonus: minilibx $(TARGETDIR)/$(TARGET_BONUS)
	@$(ERASE)
	@$(ECHO) "$(TARGET)\t\t[$(C_SUCCESS)✅$(C_RESET)]"
...
# Non-File Targets
.PHONY: all re clean fclean norm bonus minilibx
